...
public class NestedScrollViewRecyclerViewWithStickyHeaderActivityFix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nested_scroll_view_recycler_view_with_sticky_header_fix);
