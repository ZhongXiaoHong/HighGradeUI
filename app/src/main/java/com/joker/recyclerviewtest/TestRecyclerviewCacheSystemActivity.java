 ...
 */
//TODO  可视化理解RecyclerView的四种缓存的含义
//TODO  原文：https://juejin.im/post/5a5d3d9b518825734216e1e8
//TODO  https://github.com/jokermonn/RecyclerViewVisualization
public class TestRecyclerviewCacheSystemActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_test_recyclerview_cache_system);
    ...
    final LinearLayoutManager layoutManager = new LinearLayoutManager(TestRecyclerviewCacheSystemActivity.this);
  ...
  private String getMCacheViewTargetPositionInfo(RecyclerView recycledView,
    ...
    try {
      Field mAdapterHelper = Class.forName("androidx.recyclerview.widget.RecyclerView")
      ...
      Class<?> layoutStateClass =
          Class.forName("androidx.recyclerview.widget.LinearLayoutManager$LayoutState");
  ...
  class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    @Override public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      ...
      return new ViewHolder(
          LayoutInflater.from(TestRecyclerviewCacheSystemActivity.this)
              .inflate(
